...
const time = require("./lib/time.min.js");

const selectWithParent = utils.selectWithParent;
const selectAllWithParent = utils.selectAllWithParent;
//var logEvent = utils.logEvent;
const arcTween = utils.arcTween;
const onTransitionComplete = utils.onTransitionComplete;

const getNextZIndex = annotations.getNextZIndex;
...
export default d3.configurableTL;
